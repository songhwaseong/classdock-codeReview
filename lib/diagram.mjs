...
const LAYER_META = {
  ...
  'document-editors': { label: '5. document-editors', desc: 'Office·표·이미지·칠판', hue: '#7a5cd0' },
  'learning-tools': { label: '6. learning-tools', desc: '수업·과제·펫·메모·이벤트', hue: '#c0392f' },
};
...
export const buildRuntimeDiagram = (manifest, artifactSizes = {}) => {
  ...
  const parts = [
    ...
    sub(46, 154, 'manneung-classroom.html'),
    ...
    label(590, 70, '① manneung-classroom.html — 온라인 HTML'),
    ...
    label(590, 200, '② manneung-classroom-offline.html — 단일 파일'),
    ...
    label(590, 330, '③ manneung-classroom.exe — 로컬 서버 동반'),
    ...
    sub(590, 430, '모든 위험 엔드포인트는 실행별 X-Manneung-Token 을 요구.'),
