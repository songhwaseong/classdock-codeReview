  ...
  return [
    sec({
      ...
      summary:
        ...
        '수업 녹화·재생, 임시 메모와 블록 문서, 집중 타이머와 픽셀 펫이 여기 있습니다. 그리고 계층의 마지막 두 파일 app.js·command-palette.js 가 ' +
      ...
      notes: [
        ...
        },
        {
          ...
          label: 'Risk',
          body:
            '펫 관련 5개 파일이 이 계층의 4분의 1입니다. 기능적으로는 부수적인데 파일 수와 테스트 수(펫 관련 단위 테스트 8개)가 상당합니다. 유지보수 비중을 의식할 필요가 있습니다.',
        },
        {
          type: 'risk',
          label: 'Risk',
          body: 'app.js 1,937줄이 "사실상 모든 기능 파일"과 얽혀 있습니다. 계층 마지막이라 구조적으로는 맞지만, 여기 생긴 버그는 재현 조건이 복잡해집니다.',
        },
      ],
    }),
    ...
    mod('scratchpad.js', {
      ...
      notes: [
        ...
        },
        {
          ...
          label: 'Risk',
          body:
            '2,238줄에 메모 모델·블록 4종·펼치기 2종·검색·마이그레이션이 함께 있습니다. mnote.js 와 블록 개념이 겹치는데 코드는 공유하지 않습니다.',
        },
      ],
    }),
    ...
    mod('app.js', {
      ...
      notes: [
        ...
        },
        {
          ...
          label: 'Risk',
          body:
            '1,937줄에 앱 전체의 이벤트가 모여 있습니다. 여기서 생긴 버그는 "어떤 기능과 어떤 기능을 같이 썼을 때"라는 조합 조건을 갖기 쉬워 재현이 어렵습니다.',
        },
        {
          type: 'risk',
          label: 'Risk',
